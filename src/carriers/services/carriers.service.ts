...
export class CarriersService {
  ...
  async create(
    ...
    console.log('Creating carrier with:', { tenantId, userId, createCarrierDto });
    ...
    // Create new carrier with all required fields
    ...
    // Add console.log to debug the carrier object
    console.log('Carrier object before save:', carrier);
  ...
  async findAll(tenantId: number, query: ListCarriersDto) {
    ...
    // Apply sorting with proper type casting
    queryBuilder.orderBy(`carrier.${sortBy}`, sortOrder as 'ASC' | 'DESC');
